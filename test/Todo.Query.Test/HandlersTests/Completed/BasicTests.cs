...
namespace Todo.Query.Test.HandlersTests.Completed
{
    public class BasicTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        [Fact]
        public async Task When_NewTaskCompletedEventHandled_TaskSaved()
        {
        ...
        [Fact]
        public async Task When_DuplicateTaskCompletedEventHandled_DuplicateEventIgnored()
        {
            var todoTask = await _dbContextHelper.InsertAsync(new TodoTaskFaker().Generate());
        ...
        [Fact]
        public async Task When_TaskCompletedEventHandledBeforeCreatedEventArrives_EventNotHandled()
        {
            var @event = new TaskCompletedFaker()
                .Generate();
        ...
        [Fact]
        public async Task When_TaskCompletedEventWithOldSequenceHandled_EventIgnored()
        {
        ...
        [Fact]
        public async Task When_TaskCompletedEventWithSameSequenceHandled_EventIgnored()
        {
            var todoTaskBefore = await _dbContextHelper.InsertAsync(new TodoTaskFaker().Generate());
        ...
        [Fact]
        public async Task When_TaskCompletedEventHandledPrematurely_EventNotHandled()
        {
            var todoTaskBefore = await _dbContextHelper.InsertAsync(new TodoTaskFaker().Generate());
