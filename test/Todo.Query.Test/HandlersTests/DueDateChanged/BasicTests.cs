...
namespace Todo.Query.Test.HandlersTests.DueDateChanged
{
    public class BasicTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        [Fact]
        public async Task When_NewTaskDueDateChangedEventHandled_TaskSaved()
        {
        ...
        [Fact]
        public async Task When_DuplicateTaskDueDateChangedEventHandled_DuplicateEventIgnored()
        {
            var todoTask = await _dbContextHelper.InsertAsync(new TodoTaskFaker().Generate());
        ...
        [Fact]
        public async Task When_TaskDueDateChangedEventHandledBeforeCreatedEventArrives_EventNotHandled()
        {
            var @event = new TaskDueDateChangedFaker()
                .Generate();
        ...
        [Fact]
        public async Task When_TaskDueDateChangedEventWithOldSequenceHandled_EventIgnored()
        {
        ...
        [Fact]
        public async Task When_TaskDueDateChangedEventWithSameSequenceHandled_EventIgnored()
        {
            var todoTaskBefore = await _dbContextHelper.InsertAsync(new TodoTaskFaker().Generate());
        ...
        [Fact]
        public async Task When_TaskDueDateChangedEventHandledPrematurely_EventNotHandled()
        {
            var todoTaskBefore = await _dbContextHelper.InsertAsync(new TodoTaskFaker().Generate());
